...
All done! For the full python implementation of the code presented, see the file [GPT-lite repo](https://github.com/brunomaga/brunomaga.github.io/tree/master/assets/GPT-lite).
