...
{: style="text-align:center; font-size: small;"}
<img width="50%" height="50%" src="/assets/Slicing/table.png">
...
{: style="text-align:center; font-size: small;"}
 <img width="50%" height="50%" src="/assets/Slicing/balance.png">
...
{: style="text-align:center; font-size: small;"}
 <img width="50%" height="50%" src="/assets/Slicing/split.png">
...
{: style="text-align:center; font-size: small;"}
<img width="60%" height="60%" src="/assets/Slicing/STR_steps.png">
...
{: style="text-align:center; font-size: small;"}
<img width="40%" height="40%" src="/assets/Slicing/SBS.png">
