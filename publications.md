...
||| <img width="90%" height="90%" src="/assets/publications/bert2.png"/> |
||||
...
||| <img width="50%" height="50%" src="/assets/publications/transformer.png"/> |
||||
...
||| <img width="90%" height="90%" src="/assets/publications/seq2seq.png"/> |
||||
...
||| Detailed on a different post: [different blot post]({{ site.baseurl }}{% post_url 2019-10-12-Variational-Autoencoders %})
...
||| <img width="70%" height="70%" src="/assets/publications/vae_loss.png"/> |
