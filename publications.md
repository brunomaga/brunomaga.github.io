...
3. Self-supervised loss for sentence-order prediction (SOP), for performance improvement. SOP primary focuses on inter-sentence coherence and is designed
to address the ineffectiveness of the next sentence prediction (NSP) loss proposed in the original BERT.
